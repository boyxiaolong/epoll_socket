...
static void InitDefaultsLogin() {
  ...
  {
    void* ptr = &::example::_Login_default_instance_;
    new (ptr) ::example::Login();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::example::Login::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::example::Login, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::example::Login)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::example::_Login_default_instance_),
};
...
Login::Login()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:example.Login)
}
...
Login::~Login() {
  // @@protoc_insertion_point(destructor:example.Login)
  SharedDtor();
}
...
void Login::Clear() {
// @@protoc_insertion_point(message_clear_start:example.Login)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:example.Login)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:example.Login)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:example.Login)
  return false;
#undef DO_
}
...
void Login::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:example.Login)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:example.Login)
}

::google::protobuf::uint8* Login::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:example.Login)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:example.Login)
  return target;
}

size_t Login::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:example.Login)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:example.Login)
  GOOGLE_DCHECK_NE(&from, this);
  const Login* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Login>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:example.Login)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:example.Login)
    MergeFrom(*source);
  }
}

void Login::MergeFrom(const Login& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:example.Login)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:example.Login)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:example.Login)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::example::Login* Arena::CreateMaybeMessage< ::example::Login >(Arena* arena) {
  return Arena::CreateInternal< ::example::Login >(arena);
}
}  // namespace protobuf
}  // namespace google
